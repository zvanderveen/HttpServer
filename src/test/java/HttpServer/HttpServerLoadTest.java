...
import HttpServer.Request.RequestTestHelper;
...
public class HttpServerLoadTest {
    ...
    public void GetLoadTest() throws IOException {
        ...
        RequestTestHelper.MakeSureFileExists(FILE_A_NAME, FILE_A_TEXT);
        RequestTestHelper.MakeSureFileExists(FILE_B_NAME, FILE_B_TEXT);
